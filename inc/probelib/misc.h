 ...
 * @warning Device ID must begin from 1. Device ID 0 is used internally for "No device selected", and will be
 * discarded when displaying device list if you assign a device with ID 0.
 */
