...
namespace Konsole {
    ...
    class QTERMWIDGET_EXPORT HistoryScroll {
    public:
        ...
        virtual void addCellsVector(const QVector<Character> &cells) { addCells(cells.data(), cells.size()); }
        ...
        //
        const HistoryType &getType() const { return *_historyType; }
