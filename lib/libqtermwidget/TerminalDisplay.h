...
namespace Konsole {
     ...
     */
    class QTERMWIDGET_EXPORT TerminalDisplay : public QWidget {
        Q_OBJECT
    ...
    private:
        ...
        void drawCharacters(QPainter &painter, const QRect &rect, const std::wstring &text, const Character *style,
