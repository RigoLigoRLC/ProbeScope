...
public:
    ...
    int getShellPID() override { return 0; }

    /**
     * Get the PID of the foreground process
     */
    int getForegroundProcessId() override { return 0; }
     ...
     *
     * @note This function is needed in addition to the static one for making it availble when accessing QTermWidget as
     * a plugin.
     *
    ...
    /**
     * Returns a PTY IO Device. This is what intended to be used when you
     * read/write with the PTY connected to the dumb terminal
     */
    BarePty *getPtyIo() const;
