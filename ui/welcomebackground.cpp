...
void WelcomeBackground::paintEvent(QPaintEvent *event) {
    ...
    painter.drawText(symbolTipRect, Qt::AlignHCenter | Qt::AlignTop, tr("Drag and drop a symbol file here to start."));
