 ...
 *
 * Provide it with a list of ProbeLibs, currect ProbeLib and current connected probe, call execWithState.
...
public:
    ...
    probelib::IProbeLib *selectedProbeLib() const { return m_currentProbeLib; }
    probelib::IAvailableProbe::p selectedProbe() const { return m_currentProbe; }
